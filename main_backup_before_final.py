...
class SliqTest(ctk.CTk):
    ...
    def show_cps(self):
        ...
        self.cps_status.pack(pady=(30, 0))
        ...
        # IMPORTANT:
        # We intentionally use a normal tkinter Button here.
        # This avoids CTkButton command handling limiting very
        # fast clicks.

        self.cps_button = tk.Button(
            panel,
            text="CLICK!",
            font=("Arial", 26, "bold"),
            bg=ACCENT,
        ...
        if len(self.cps_click_times) >= 20:
            ...
            if intervals:
                ...
                if avg > 0:
                    ...
                    variation = deviation / avg

                    # Consistent interval detection.
                    # This does NOT block legitimate fast clicks.
                    if (
                        0.015 <= avg <= 1.0
                        and variation < 0.035
                    ):
                        ...
                        self.cps_timer_label.configure(
                            text="Suspiciously consistent clicking detected."
                        )
    ...
    def update_cps(self):
        ...
        remaining = self.cps_end - time.perf_counter()
    ...
    def finish_cps(self):
        ...
        if self.cps_timer_job:
            ...
            try:
                self.after_cancel(self.cps_timer_job)
            except Exception:
                pass
        ...
        if self.cps_auto_click_detected:
            ...
            self.cps_timer_label.configure(
                text="This result was not saved."
            )
    ...
    def reaction_mouse_click(self, event=None):
        ...
        if self.reaction_state == "go":
            ...
            if (
                ...
                or milliseconds < data["best_reaction"]
            ):
        ...
        difficulty = self.reaction_difficulty.get()
    ...
    def show_statistics(self):
        ...
        if cps:
            ...
            text = "No CPS tests completed yet."
        ...
        if reaction:
            ...
            average = sum(reaction) / len(reaction)
            ...
            text = "No reaction tests completed yet."
